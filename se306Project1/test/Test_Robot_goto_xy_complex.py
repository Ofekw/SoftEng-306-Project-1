...
This is a test for the ability of the function goto_xy in a more complex sense, using diagonal travels

"""
class Test_Robot_goto_xy_complex(unittest.TestCase,TestModule):
    ...
    def test_goto_xy_1move_up_right(self):
    ...
    def test_goto_xy_2move_down_left(self):
    ...
    def test_goto_xy_3move_up_left(self):
    ...
    def test_goto_xy_4move_down_right(self):
...
if __name__ == '__main__':
    # unittest.main()
    import rostest
    rostest.rosrun('se306Project1', 'test_bare_bones', Test_Robot_goto_xy_complex)